...
- usage: 사용법 (1~2문장)
- marketing_points: 마케팅 포인트 (수상, 랭킹, 인증, 특허 등, 배열)
- selling_phrases: 이미지에서 강조된 핵심 셀링 문구 (배열)
- certifications: 인증 마크 (비건, 더마, EWG 등, 배열)
- reviews_summary: 리뷰 관련 내용이 있다면 요약
